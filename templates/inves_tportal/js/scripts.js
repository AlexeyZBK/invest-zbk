...
$(window).scroll(function(){
	...
	if(scrollering > invest_map.offset().top - $(window).height()){
		var offsett = Math.min(0,scrollering - invest_map.offset().top + ($(window).height()-830));
	...
	if(scrollering > navigator_inv.offset().top - $(window).height()){
		var offsett = Math.min(0,scrollering - navigator_inv.offset().top + ($(window).height()-430));
	...
	var navigator_inv = $('#navigator_inv');
	if(scrollering > navigator_inv.offset().top - $(window).height()){
		var offsett = Math.min(0,scrollering - navigator_inv.offset().top + ($(window).height()-820));
	...
	if(scrollering > stati_sliders.offset().top - $(window).height()){
		var offsett = Math.min(0,scrollering - stati_sliders.offset().top + ($(window).height()-650));
		$('.firstst .item-wrap:even').css({'transform' : 'translate('+ Math.abs(offsett) +'px , 0)'});
		$('.firstst .item-wrap:odd').css({'transform' : 'translate('+ offsett +'px , 0)'});
	}

	var stati_sliders = $('#stati_sliders');
	if(scrollering > stati_sliders.offset().top - $(window).height()){
		var offsett = Math.min(0,scrollering - stati_sliders.offset().top + ($(window).height()-880));
		$('.secondst .item-wrap:odd').css({'transform' : 'translate('+ offsett +'px , 0)'});
		$('.secondst .item-wrap:even').css({'transform' : 'translate('+ Math.abs(offsett) +'px , 0)'});
	}
});
/********************************************************** PARALLAXXX **********************************************************/
