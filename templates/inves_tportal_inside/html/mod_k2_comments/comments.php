	...
	<ul>
		...
		<li class="<?php echo ($key%2) ? "odd" : "even"; if(count($comments)==$key+1) echo ' lastItem'; ?>">
			...
			<span class="lcUsername">
				...
				<?php endif; ?> <i class="fa fa-user"></i>
			</span> 
			<?php endif; ?>

			<?php if($params->get('commentDate')): ?>
			<span class="lcCommentDate">Комменткрий от 
			...
			<span class="lcItemTitle" style="padding-top:7px;display:inline-block;"><a href="<?php echo $comment->itemLink; ?>"><?php echo $comment->title; ?></a></span>
			<?php endif; ?>
			<br><hr width="60%" size="1">
