	...
	<?php if ( $loginMethod != 4 ) { ?>
		<div class="userdata">
							...
							<div class="input-prepend input-append">
								<span class="add-on">
									<span class="<?php echo htmlspecialchars( $templateClass ); ?>">
										<span id="fa-user" class="fa fa-user" title="<?php echo htmlspecialchars( $userNameText ); ?>"></span>
									</span>
								</span>
								<input id="modlgn-username" type="text" name="username" class="input-small"  size="<?php echo $usernameInputLength; ?>"<?php echo ( in_array( $showUsernameLabel, array( 4, 5 ) ) ? ' placeholder="' . htmlspecialchars( $userNameText ) . '"' : null ); ?> autocomplete="off" />
							</div>
						<?php } else { ?>
							...
							<input id="modlgn-username" type="text" name="username" class="input-medium"  size="<?php echo $usernameInputLength; ?>"<?php echo ( in_array( $showUsernameLabel, array( 4, 5 ) ) ? ' placeholder="' . htmlspecialchars( $userNameText ) . '"' : null ); ?>  autocomplete="off" />
						<?php } ?>
					<?php } else { ?>
						<input id="modlgn-username" type="text" name="username" class="input-medium"  size="<?php echo $usernameInputLength; ?>"<?php echo ( in_array( $showUsernameLabel, array( 4, 5 ) ) ? ' placeholder="' . htmlspecialchars( $userNameText ) . '"' : null ); ?>  autocomplete="off" />
					<?php } ?>
					...
					<?php if ( in_array( $showPasswordLabel, array( 1, 2, 3, 5 ) ) ) { ?>
						<?php if ( in_array( $showPasswordLabel, array( 2, 3, 5 ) ) ) { ?>
							...
							<div class="input-prepend input-append">
								<span class="add-on">
									<span class="<?php echo htmlspecialchars( $templateClass ); ?>">
										<span id="fa-key" class="fa fa-key" title="<?php echo htmlspecialchars( CBTxt::T( 'Password' ) ); ?>"></span>
									</span>
								</span>
								<input id="modlgn-passwd" type="password" name="passwd" class="input-small" size="<?php echo $passwordInputLength; ?>"<?php echo ( in_array( $showPasswordLabel, array( 4, 5 ) ) ? ' placeholder="' . htmlspecialchars( CBTxt::T( 'Password' ) ) . '"' : null ); ?>  autocomplete="off" />
							</div>
						<?php } else { ?>
							...
							<input id="modlgn-passwd" type="password" name="passwd" class="input-medium" size="<?php echo $passwordInputLength; ?>"<?php echo ( in_array( $showPasswordLabel, array( 4, 5 ) ) ? ' placeholder="' . htmlspecialchars( CBTxt::T( 'Password' ) ) . '"' : null ); ?>  autocomplete="off"  />
						<?php } ?>
					<?php } else { ?>
						<input id="modlgn-passwd" type="password" name="passwd" class="input-medium" size="<?php echo $passwordInputLength; ?>"<?php echo ( in_array( $showPasswordLabel, array( 4, 5 ) ) ? ' placeholder="' . htmlspecialchars( CBTxt::T( 'Password' ) ) . '"' : null ); ?>  autocomplete="off"  />
					<?php } ?>
			...
			<div id="form-login-submit" class="control-group">
				<div class="controls">
					<button id="btnSL" type="submit" name="Submit" class="btn btn-primary"<?php echo $buttonStyle; ?>>
