...
window.addEvent("load", function () {
	...
	$('jform_params_yjk2filter_extrafields0').addEvent('click', function () {
		...
		//J30 remove old element and create new chzn div		
		jQuery_select('jformparamsyjk2filter_extrafields_id');
	});
	...
	$('jform_params_yjk2filter_groups1').addEvent('click', function () {
		...
		get_group_available_extra_fields();
		//J30 remove old element and create new chzn div		
		//jQuery_select('jformparamsyjk2filter_groups_id');			
	});
	...
	$('jform_params_yjk2filter_available_group_fields0').addEvent('click', function () {
		...
		//J30 remove old element and create new chzn div		
		jQuery_select('jformparamsyjk2filter_available_group_fields_selected');		
	});
	...
	if ($('jformparamsyjk2filter_fields_group_id').get("value") == "") {
		...
		var req = new Request({
			...
			onComplete: function(response) { 
				...
				$("jformparamsyjk2filter_extrafields_id").getParent().set("html", response);
	...
	$$('#jformparamsyjk2filter_fields_group_id_chzn .active-result').addEvent('click', function (event) {
		...
		var req = new Request({
			...
			onComplete: function(response) { 
				//$$('li.yjk2filter_extrafields_id_yjme').set({'html':response}); 
				//$('div.control-group yjk2filter_extrafields_id_yjme div.controls').set({'html':response});
				$("jformparamsyjk2filter_extrafields_id").getParent().set("html", response);
	...
	$$('#jform_params_yjk2filter_create_groups_range_chzn .active-result').addEvent('click', function (event) {
		event.stop();
	...
	$$('#jform_params_yjk2filter_create_extrafields_range_chzn .active-result').addEvent('click', function (event) {
		event.stop();
	...
	var yjk2filterSlide1 = new Fx.Slide('yjk2filter_groups_holder', {
		...
		transition: Fx.Transitions.Pow.easeOut/*,
		onComplete: function(){
			alert('yjk2filter_groups_holder slided');
		}*/
	});
	var yjk2filterSlide2 = new Fx.Slide('yjk2filter_fields_holder', {
		...
		transition: Fx.Transitions.Pow.easeOut/*,
		onComplete: function(){
			alert('yjk2filter_fields_holder slided');
		}*/
	});	
	var selected = $('jform_params_yjk2filter_groups_filter').get("value");
	if (selected == 0) {
		yjk2filterSlide1.slideOut('vertical');
		yjk2filterSlide2.slideIn('vertical');
	} else if (selected == 1) {
		yjk2filterSlide1.slideIn('vertical');
		yjk2filterSlide2.slideOut('vertical');
	}
	
	$$('#jform_params_yjk2filter_groups_filter_chzn .active-result').addEvent('click', function (event) {
		event.stop();

		var selectedsource = $('jform_params_yjk2filter_groups_filter').get("value");
...
function get_group_available_extra_fields(){
	...
	var req = new Request({
		...
		onComplete: function(response) { 
			...
			//added in J30 - start
			$$('#jformparamsyjk2filter_groups_id_chzn .active-result').addEvent('click', function (event) {
				event.stop();
				get_group_available_extra_fields();	
			});
			$$('#jformparamsyjk2filter_groups_id_chzn .search-choice-close').addEvent('click', function (event) {
				event.stop();
				get_group_available_extra_fields();	
			});	
			//added in J30 - end		
