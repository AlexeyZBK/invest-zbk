...
class JFormFieldk2groupsmultiple extends JFormField
{

	var	$type = 'k2groupsmultiple'; 
	...
	if($k2_check):
		...
		$db = JFactory::getDBO();
		$query = 'SELECT m.* FROM #__k2_extra_fields_groups as m ORDER BY m.name ASC';
		$db->setQuery( $query );
		...
		if(is_array($list) && !empty($list)):
			...
			$output= '
				<select id="jformparamsyjk2filter_groups_id" class="inputbox" size="10" multiple="multiple" style="width:90%;" name="params[yjk2filter_groups_id][]" disabled="disabled">
