...
class JFormFieldData extends JFormField
{
    ...
    protected function getInput()
    {
		...
		{
            $j30 = 0;
            $doc->addScript(JURI::root().'modules/mod_vina_slicebox_image_slider/assets/js/jquery-1.8.3.min.js', 'text/javascript');
            $doc->addScript(JURI::root().'modules/mod_vina_slicebox_image_slider/assets/js/chosen.jquery.min.js', 'text/javascript');
            $doc->addStyleSheet(JURI::root().'modules/mod_vina_slicebox_image_slider/assets/css/chosen.css', 'text/css');
        }

        $doc->addScript('https://ajax.googleapis.com/ajax/libs/jqueryui/1.9.1/jquery-ui.min.js', 'text/javascript');
        $doc->addScript(JURI::root().'modules/mod_vina_slicebox_image_slider/libs/elements/media/slideset.js', 'text/javascript');
        $doc->addScript(JURI::root().'modules/mod_vina_slicebox_image_slider/libs/elements/media/json2.js', 'text/javascript');

        $doc->addStyleSheet('https://ajax.googleapis.com/ajax/libs/jqueryui/1.9.0/themes/cupertino/jquery-ui.css', 'text/css');
        $doc->addStyleSheet(JURI::root().'modules/mod_vina_slicebox_image_slider/libs/elements/media/slideset.css', 'text/css');

        if($this->value){
            $slide = json_decode($this->value);
        }
		else {
            $slide = json_decode('{"src":"list","list":[{"name":"Slide item 1","img":"modules/mod_vina_slicebox_image_slider/samples/image-1.jpg","text":"<div style=\"bottom: 120px\" class=\"sb-description\">\n\t<h3>Vina Slicebox Image Slider </h3>\n</div>\n<div style=\"bottom: 40px\" class=\"sb-description\">\n\t<h3>A fresh 3D image slider module with graceful fallback!</h3>\n</div>"},{"name":"Slide item 2","img":"modules/mod_vina_slicebox_image_slider/samples/image-2.jpg","text":"<div style=\"top: 50%; bottom: auto; width: 360px; background: rgba(0, 0, 0, 0.8);\" class=\"sb-description\">\n\t<h3>Image Captions Here!</h3>\n\t<p>Proin gravida nibh vel velit auctor aliquet. Aenean sollicitudin, lorem quis bibendum auctor, nisi elit consequat ipsum.</p>\n\t<div style=\"line-height: 30px\">\n\t\t<a href=\"http://vinagecko.com\" style=\"padding: 5px 10px; color: #000; background: #FB8E30; margin-right: 10px;\">Download Now >></a>\n\t\t<a href=\"http://vinagecko.com\" style=\"padding: 5px 10px; background: #E52626; color: #FFF;\">View other module >></a>\n\t</div>\n</div>"},{"name":"Slide item 3","img":"modules/mod_vina_slicebox_image_slider/samples/image-3.jpg","text":"<div style=\"width: 100%; bottom: 0px; background: rgba(0, 0, 0, 0.6);\" class=\"sb-description\">\n\t<h3>Image Captions Here!</h3>\n\t<p>Proin gravida nibh vel velit auctor aliquet. Aenean sollicitudin, lorem quis bibendum auctor.</p>\n</div>"},{"name":"Slide item 4","img":"modules/mod_vina_slicebox_image_slider/samples/image-4.jpg","text":"<div style=\"width: 60%; background: rgba(0, 0, 0, 0.7); bottom: 15%; left: 10%;\" class=\"sb-description\">\n\t<h3>Image Captions Here!</h3>\n\t<p>Proin gravida nibh vel velit auctor aliquet. Aenean sollicitudin, lorem quis bibendum auctor, nisi elit consequat ipsum <a href=\"http://vinagecko.com\" style=\"color: #FB8E30\">Read more...</a></p>\n</div>"},{"name":"Slide item 5","img":"modules/mod_vina_slicebox_image_slider/samples/image-5.jpg","text":"<div class=\"sb-description\" style=\"top: 60%; right: 0; bottom: auto; width: 360px; background: rgba(0, 0, 0, 0.6);\">\n\t<h3>Image Captions Here!</h3>\n\t<p>Proin gravida nibh vel velit auctor aliquet. Aenean sollicitudin, lorem quis bibendum auctor, nisi elit consequat ipsum.</p>\n</div>"},{"name":"Slide item 6","img":"modules/mod_vina_slicebox_image_slider/samples/image-6.jpg","text":"<div class=\"sb-description\" style=\"top: 50%; right: 15%; bottom: auto; width: 360px; background: rgba(0, 0, 0, 0.6);\">\n\t<h3>Image Captions Here!</h3>\n\t<p>Proin gravida nibh vel velit auctor aliquet. Aenean sollicitudin, lorem quis bibendum auctor, nisi elit consequat ipsum.</p>\n</div>"}],"dir":{"path":"modules/mod_vina_slicebox_image_slider/samples/","ext":".jpg,.png"},"art":{}}');
        }
        ob_start();
        ?>
    <style type="text/css">
        ...
        <div id="tcvnSlideSet-dir">
            <div class="tcvnSlideSet-item">
                <div class="tcvnSlideSet-input">
                    <label>Path</label>
                    <input id="tcvnSlideSet-path" value="<?php if(isset($slide->dir->path)) echo $slide->dir->path; else echo 'modules/mod_vina_slicebox_image_slider/samples/'?>"/>
                </div>
