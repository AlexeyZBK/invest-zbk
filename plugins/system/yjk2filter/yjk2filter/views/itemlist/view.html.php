...
class K2ViewItemlist extends K2View
{
    ...
    function display($tpl = null)
    {
		...
		$model = $this->getModel('yjk2filteritemlist');
        ...
        switch ($task)
        {
			...
			case 'yjk2filter':
				...
				//overwrite the model to yjk2filter model
				...
				$controller->addModelPath($YjK2FilterPath.DS."models");
				//require_once($YjK2FilterPath."/models/yjk2filteritemlist.php");
				$model = $controller->getModel('yjk2filteritemlist');

				// Set limit
				$limit = $params->get('genericItemCount');

				// Set title
				$title = JText::_('K2_SEARCH_RESULTS_FOR');
        ...
        $model = $this->getModel('yjk2filteritem');
