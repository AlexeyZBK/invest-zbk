...
CKEDITOR.addTemplates('default', {
    ...
    templates: [{
        ...
        title: 'рпрппрпрпрпрпр your own template',
        image: 'template5.gif',
        description: 'ррпрпрпрпрпрпрп you need to do to add a template. The first thing to do is work out what you would like as a template...',
